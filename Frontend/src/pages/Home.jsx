      ...
      <div className="flex items-center justify-between px-20 py-16">
        <div className="w-1/2">
          <h1 className="text-4xl font-bold mb-4">
            Empower <span className="text-pink-600">Education</span> Through
            Effective <span className="text-pink-600">Assessment</span>
          </h1>
          <p className="text-gray-600 mb-8">
            Transform your teaching experience with our intelligent assessment
            platform that makes creating, managing, and grading tests
            effortless.
          </p>
          ...
          {[
            {
              ...
              title: "Test Creation",
              description:
                "Create professional tests with our intuitive interface. Multiple question types, customizable templates, and instant preview.",
            },
            {
              icon: "🔒",
              title: "Secure Environment",
              description:
                "Advanced proctoring features, encrypted data transmission, and secure test delivery system.",
            },
            {
              icon: "📊",
              title: "Analytics",
              description:
                "Comprehensive analytics and insights. Track performance, identify trends, and generate detailed reports.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
          ...
          {[
            {
              ...
              description:
                "Sign up as an educator or student and set up your profile in minutes.",
            },
            {
              step: 2,
              title: "Design Tests",
              description:
                "Use our tools to create engaging assessments or take assigned tests.",
            },
            {
              step: 3,
              title: "Track Progress",
              description:
                "Monitor results and improve learning outcomes with detailed insights.",
            },
          ].map((step, index) => (
            <motion.div
              key={index}
