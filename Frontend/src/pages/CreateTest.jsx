              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailChange("numberOfQuestions", e.target.value)
                    }
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleDetailChange("questionType", e.target.value)
                    }
                    required
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailChange("timeLimit", e.target.value)
                    }
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(index, "options", e.target.value, 0)
                      }
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(index, "options", e.target.value, 1)
                      }
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(index, "options", e.target.value, 2)
                      }
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(index, "options", e.target.value, 3)
                      }
                      required
                    />
                  </div>
