...
export default function About() {
  ...
  const teamMembers = [
    {
      name: "Neetesh Sir",
      role: "CEO & Founder",
      description: "Former educator with 20 years of experience in Mathematics",
      image: neetesh_image, // Add actual image path
    },
    {
      name: "Rohit Anand",
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 space-y-16">
      ...
      >
        <h2 className="text-3xl font-bold mb-6">About Maths Point</h2>
        <p className="text-gray-600 max-w-3xl mx-auto">
          Maths Point is revolutionizing the way educators evaluate student
          performance. Our platform combines cutting-edge technology with
          pedagogical expertise to deliver comprehensive assessment solutions
          that help teachers save time and students achieve more. We believe in
          making education more efficient, effective, and accessible for
          everyone.
        </p>
      </motion.div>
        ...
        <form onSubmit={handleSubmit} ref={form} className="space-y-6">
          ...
          <div>
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, query_type: e.target.value })
              }
